...
import qs.modules.widgets.spotlight
...
ShellRoot {
    ...
    Variants {
        ...
        Loader {
            id: spotlightLoader
            // Siempre activo; SpotlightView gestiona su propia visibilidad
            // con showHax para permitir la animación de cierre.
            active: SuspendManager.wakeReady
            required property ShellScreen modelData
            sourceComponent: SpotlightView {
                screen: spotlightLoader.modelData
            }
        }
    }
