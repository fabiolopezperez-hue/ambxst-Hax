    ...
    function updateResults() {
        ...
        if (helpMatch) {
            newResults = [
                ...
                { name: "👁 Vista rápida (Quick Look)", description: "Previsualiza archivos dentro de Hax al navegar con ↑/↓ — imágenes, texto y binarios. Cierra con Esc", icon: Icons.notepad, type: "info", exec: null },
